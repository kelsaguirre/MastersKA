...
if flagA==0
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T0 Off'},'Location','southwest')
elseif flagA==1
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T1 Off'},'Location','southwest')
elseif flagA==2
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T2 Off'},'Location','southwest')
elseif flagA==3
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T3 Off'},'Location','southwest')
end
legend boxoff
