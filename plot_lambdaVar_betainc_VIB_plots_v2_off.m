...
%nsOff = (nsOff-1); %- added this for off T3 bc it was pulling extra datapt
disp(nsOff)
...
for tt1=1:length(ybaseline(1,:))
    [a p1(tt1) c d]=ttest2(ybaseline(:,tt1), yOff(:,tt1));
    if p1(tt1)<=.001
...
fig=filled_plot((ybaseline), Baseline_color, 0.8, (yOff), Off_color, 0.4);
hold off
...
if flagA==0
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T0 Off'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
elseif flagA==1
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T1 Off'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
elseif flagA==2
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T2 Off'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
elseif flagA==3
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T3 Off'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
end
legend boxoff
...
cd (root_folder)
if flagA==0
    save('lambdaVar_betainc_Off_T0', 'yOff')
elseif flagA==1
    save('lambdaVar_betainc_Off_T1', 'yOff')
elseif flagA==2
    save('lambdaVar_betainc_Off_T2', 'yOff')
elseif flagA==3
    save('lambdaVar_betainc_Off_T3', 'yOff')
end
