...
% Load treatment data
load('slot_T2_data.mat', 'Lat_all_data_clean', 'Off_all_data_clean', 'Thera_all_data_clean'); 
...
ylim([0 6000]);
title_text = 'Mean Reward Pre-DBS and T2'; % Define title text
title(title_text);
text(0.5, 5500, 'Pre-DBS N = 11', 'FontSize', 14);
text(3.5, 5500, 'T2 N = 10', 'FontSize', 14);
