...
for tt1=1:length(ybaseline(1,:))
    [a p1(tt1) c d]=ttest2(ybaseline(:,tt1), yThera(:,tt1));
    if p1(tt1)<=.001
...
fig=filled_plot((ybaseline), Baseline_color, 0.8, (yThera), T1_color, 0.4);
hold off
...
if flagA==0
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T0 Therapeutic'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
elseif flagA==1
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T1 Therapeutic'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
elseif flagA==2
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T2 Therapeutic'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
elseif flagA==3
    legend([fig{1}, fig{3}], {'Pre-DBS', 'T3 Therapeutic'}, 'FontName', 'Arial', 'FontWeight', 'bold', 'FontSize', 14, 'Location','southwest')
end
legend boxoff
...
cd (root_folder)
if flagA==0
    save('lambdaVar_betainc_Thera_T0', 'yThera')
elseif flagA==1
    save('lambdaVar_betainc_Thera_T1', 'yThera')
elseif flagA==2
    save('lambdaVar_betainc_Thera_T2', 'yThera')
elseif flagA==3
    save('lambdaVar_betainc_Thera_T3', 'yThera')
end
